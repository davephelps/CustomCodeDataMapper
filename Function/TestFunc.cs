...
namespace DP
{
    ...
    /// <summary>
    /// Represents the TestFunc flow invoked function.
    /// </summary>
    public class TestFunc
    {
        ...
        {
            logger = loggerFactory.CreateLogger<TestFunc>();
        }
        ...
        {
            this.logger.LogInformation("Starting TestFunc with Zip Code: " + zipCode + " and Scale: " + temperatureScale);
        ...
        /// <summary>
        /// Represents the weather information for TestFunc.
        /// </summary>
